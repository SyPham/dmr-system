            ...
            modelBuilder.Entity("DMR_API.Models.BPFCEstablish", b =>
                {
                    b.HasOne("DMR_API.Models.ArtProcess", "ArtProcess")
                        ...
                        .HasForeignKey("DMR_API.Models.BPFCEstablish", "ArtProcessID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMR_API.Models.ArticleNo", "ArticleNo")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("DMR_API.Models.BPFCEstablish", "ArticleNoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMR_API.Models.ModelName", "ModelName")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("DMR_API.Models.BPFCEstablish", "ModelNameID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMR_API.Models.ModelNo", "ModelNo")
                        .WithOne("BPFCEstablish")
                        .HasForeignKey("DMR_API.Models.BPFCEstablish", "ModelNoID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
